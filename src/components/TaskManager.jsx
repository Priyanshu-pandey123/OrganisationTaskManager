        ...
        <div className="mb-4">
          ...
          <div className="mb-4">
            <button
              ...
              className="flex items-center space-x-3 px-4 py-2  bg-blue-600 hover:bg-blue-700 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600 transition-colors duration-200"
            >
             
              <div className="text-left flex items-center  gap-1">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Create Team</h3>
                <p className="text-sm text-white border-b-2 ">{currentCompany.name}</p>
              </div>
